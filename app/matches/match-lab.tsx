...
type Prediction = { home: Team; away: Team; probabilities: { home_win: number; draw: number; away_win: number }; factors: { label: string; edge: number; favors: "home" | "away" }[]; metrics: { accuracy: number; log_loss: number; brier_score: number }; version: string };
