...
export default function MatchesPage() {
  return <main className="matches-page">
    ...
    <header className="match-hero shell"><div className="eyebrow"><span /> MATCH LAB / 03</div><div className="match-heading"><h1>Read the matchup.<br /><em>Price the uncertainty.</em></h1><div><p>Compare current team strength and recent form to estimate home-win, draw, and away-win probabilities before kickoff.</p><Link className="performance-link" href="/matches/performance">View the live prediction record →</Link></div></div></header>
    <MatchLab />
