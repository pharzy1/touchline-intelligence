...
export async function GET(request: Request) {
  ...
  try {
    const [summary, routes, errors, security, limits, syncs, alerts, records] = await Promise.all([
